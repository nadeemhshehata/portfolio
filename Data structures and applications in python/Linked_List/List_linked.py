...
class List:
    ...
    def _reverse_r_aux(self, node):
        ...
        if node is None or node._next is None:
            ...
            new_front = self._reverse_r_aux(node._next)
    ...
    def __eq__(self, target):
        ...
        if len(target) != self._count:
            ...
            while current1 is not None and current2 is not None and equals:
    ...
    def intersection(self, source1, source2):
        ...
        while current1 is not None:
            if current1._value not in seen_values:
                _, current2, _ = source2._linear_search(current1._value)
