...
class List:
    ...
    def _is_valid_index(self, i):
        ...
        # Your code here
        flag = False
        if i >= -len(self._values) and i <= len(self._values)-1:
            flag = True
    ...
    def _linear_search(self, key):
        ...
        i = -1
        counter = 0
        while len(self._values) != counter:
            if self._values[counter] == key:
                i = self._values.index(key)
                break
            counter = counter+1
    ...
    def combine(self, source1, source2):
        ...
        while len(source1._values) > 0 and len(source2._values) > 0:
            if i % 2 == 0:
                self.append(source1._values.pop(0))
            else:
                self.append(source2._values.pop(0))
            i += 1
    ...
    def find(self, key):
        ...
        # while len(self._values) != counter:
        #     if self._values[counter] == key:
        #         value = deepcopy(self._values[counter])
        #     counter = counter+1
        if self._linear_search(key) == -1:
            value = None
        else:
            value = deepcopy(self._values[self._linear_search(key)])
    ...
    def split(self):
        ...
        left = List()
        right = List()
        left._values = self._values[:middle]
        right._values = self._values[middle:]
        return left, right
